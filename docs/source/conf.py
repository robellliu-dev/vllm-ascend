...
_VLLM_MAIN_VERIFIED_COMMIT = (_REPO_ROOT / ".github" / "vllm-main-verified.commit").read_text(encoding="utf-8").strip()
_VLLM_RELEASE_TAG = (_REPO_ROOT / ".github" / "vllm-release-tag.commit").read_text(encoding="utf-8").strip()
